...
public:
    ...
    LGFX(void)
    {
...

        {
            ...
            cfg.pin_d0 = GPIO_NUM_17;  // B3
            cfg.pin_d1 = GPIO_NUM_16;  // B4
            cfg.pin_d2 = GPIO_NUM_15; // B5
            cfg.pin_d3 = GPIO_NUM_7;  // B6
            cfg.pin_d4 = GPIO_NUM_6;  // B7

            cfg.pin_d5 = GPIO_NUM_10;  // G2
            cfg.pin_d6 = GPIO_NUM_9;  // G3
            cfg.pin_d7 = GPIO_NUM_46;  // G4
            cfg.pin_d8 = GPIO_NUM_3; // G5
            cfg.pin_d9 = GPIO_NUM_8; // G6
            cfg.pin_d10 = GPIO_NUM_18; // G7
